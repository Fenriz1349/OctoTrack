...
final class ViewModelFactory: ObservableObject {
    ...
    func makeAccountViewModel(authenticationViewModel: AuthenticationViewModel,
                              viewModelFactory: ViewModelFactory) -> AccountViewModel {
        return AccountViewModel(dataManager: dataManager,
